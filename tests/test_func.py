...
@must_be(
    "Bad arguments.",
    "tests/test_func.py:7:16:17:     with0(1, 2, 3)",
    "                                                ^",
)
...
@must_be(
    "Missing argument 'x'.",
    "tests/test_func.py:7:4:9:     with1()",
    "                                  ^^^^^",
)
...
@must_be(
    "Bad arguments.",
    "tests/test_func.py:7:13:14:     with1(1, 2)",
    "                                             ^",
)
...
@must_be(
    "Bad arguments.",
    "tests/test_func.py:7:22:23:     with0(1, 2, 3, 2, 1)",
    "                                                      ^",
)
...
@must_be(
    "Bad arguments.",
    "tests/test_func.py:7:23:24:     withv2(1, 2, 3, 2, 1)",
    "                                                       ^",
)
...
@must_be(
    ...
    "tests/test_func.py:7:4:6:     t0(foo=100, bar=7)",
    "                                  ^^",
)
...
@must_be(
    "Missing argument 'z'.",
    "tests/test_func.py:7:16:17:     withv2(1, q=7)",
    "                                                ^",
)
...
@must_be(
    "Missing argument 'z'.",
    "tests/test_func.py:7:18:19:     withv2(1, zap=7)",
    "                                                  ^",
)
...
@must_be(
    "Missing argument 'z'.",
    "tests/test_func.py:7:17:18:     withv2(1, za=3)",
    "                                                 ^",
)
...
@must_be(
    "Missing argument 'x'.",
    "tests/test_func.py:7:15:16:     withv2(za9=3)",
    "                                               ^",
)
...
@must_be(
    ...
    "tests/test_func.py:8:4:8:     ins1(T)",
    "                                  ^^^^",
)
...
@must_be(
    ...
    "tests/test_func.py:8:4:11:     inside2(T[0], T[1])",
    "                                   ^^^^^^^",
)
...
@must_be(
    ...
    "tests/test_func.py:9:4:11:     inside3(T[0], T[1], V)",
    "                                   ^^^^^^^",
)
...
@must_be(
    ...
    "tests/test_func.py:7:4:6:     t1(0, 1)",
    "                                  ^^",
)
...
@must_be(
    "Name 't1' is not defined.",
    "tests/test_func.py:7:4:6:     t1(zap=123, dog=999)",
    "                                  ^^",
)
...
@must_be(
    "Name 't1' is not defined.",
    "tests/test_func.py:7:4:6:     t1(zap=123)",
    "                                  ^^",
)
...
@must_be(
    "Bad arguments.",
    "tests/test_func.py:8:15:16:     callunp1(**x)",
    "                                               ^",
)
