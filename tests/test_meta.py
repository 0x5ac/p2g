...
from p2g.ptest import check_golden
from p2g.ptest import must_be
from p2g.walk import compile2g
...
def test_native_tolist():
    got = compile2g("tolist_worker", __file__, job_name=None)
    r = "#100" in got[1]
    assert r
...
# def test_native_@check_and_remove_golden():
