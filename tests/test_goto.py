...
@want(
    "O00001 (test_a)                                   ",
    "( goto.work.feed[200].z_first[z=10])              ",
    "  G90 G01 G55 F200. z10.                          ",
    "  M30                                             ",
    "%                                                 ",
)
def test_a():
...
@want(
    errors=[
        "test_goto.py:8:24:25:     p2g.goto.r9810.feed(7).relative.z_first(1, 2, 3)",
        "                                              ^   ",
...
@want(
    errors=[
        "test_goto.py:7:47:48:     p2g.goto.r9810.feed(7).probe.z_first(1, 2, 3)",
...
@want(
    errors=[
        'test_goto.py:7:52:53:     p2g.goto.r9810.feed(7).mcode("a").z_first(1, 2, 3)',
...
@want(
    errors=[
        "test_goto.py:7:28:29:     p2g.goto.work.xyz(1, 2, 3)",
        "Need feed rate.                                   ^",
    ]
)
...
@want(
    errors=[
        "test_goto.py:8:4:7:     p2g.goto.xyz.z_first.feed(7).relative.z_first(1, 2, 3)",
        "                        ^^^                       ",
...
@want(
    errors=[
        "test_goto.py:8:36:37:     p2g.goto.feed(7).relative(1, 2, 3)",
        "                                                          ^",
...
@want(
    errors=[
        "test_goto.py:8:35:36:     p2g.goto.feed(7).z_first(1, 2, 3)",
        "                                                         ^",
