...
def test_3axis():
    xyz = p2g.Var(p2g.haas.LAST_TARGET_POS)
    xyz += 9
...
def test_5axis():
    ...
    thing = p2g.Var(p2g.haas.LAST_TARGET_POS)
    thing.xyzac = [1, 2, 3, 4, 5]
...
@want(
    errors=[
        "test_axes.py:9:4:7:     xyz.xyzabc = 32           ",
        "                        ^^^                       ",
