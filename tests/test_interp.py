...
@want(
    errors=[
        ...
        "tests/test_interp.py:11:11:16:     V[0] = dummy.v1",
        "                                          ^^^^^   ",
    ]
)
...
@want(
    errors=[
        ...
        "tests/test_interp.py:9:4:41:     from pytest import undefined as dummy",
        "                                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^",
    ]
)
...
@want(
    errors=[
        ...
        "tests/test_interp.py:9:4:16:     try:             ",
        "                                 ^^^^^^^^^^^^     ",
    ]
)
def test_cerror_tr():
...
@want(
    errors=[
        "Feature 'try' not implemented.                    ",
        "tests/test_interp.py:9:4:12:     try:             ",
        "                                 ^^^^^^^^         ",
    ]
)
def test_cerror_try():
...
@want(
    errors=[
        ...
        "tests/test_interp.py:9:9:18:     with undefined():  # type: ignore  # noqa: F821",
        "                                      ^^^^^^^^^   ",
    ]
)
