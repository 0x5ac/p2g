...
@want(
    errors=[
        "test_coords.py:8:25:27:     v = p2g.Var[10](addr=20)",
...
@want(
    errors=[
        "test_coords.py:8:17:18:     p2g.Var[100](2)       ",
...
@want(
    errors=[
        "test_coords.py:8:28:31:     p2g.Const[2](1, 2, addr=123)",
...
@want(
    errors=[
        "test_coords.py:8:17:18:     p2g.Var(2, x=3)       ",
...
@want(
    errors=[
        "test_coords.py:7:25:26:     p2g.Var[10](1, 2, 3, 4)",
...
@want(
    errors=[
        "test_coords.py:7:22:23:     p2g.Const[2](addr=0)  ",
        "Const can't have an address.                  ^   ",
    ]
)
...
@want(
    errors=[
        "test_coords.py:7:31:32:     p2g.Const[0](1, 2, 3, addr=0)",
...
@want(
    errors=[
        "test_coords.py:7:14:15:     p2g.Const[0]()        ",
        "Zero sized vector.                    ^           ",
    ]
)
