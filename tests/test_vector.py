...
@want(
    errors=[
        ...
        "tests/test_vector.py:10:10:11:     k = j[5]       ",
        "                                         ^        ",
    ]
)
...
@want(
    errors=[
        ...
        "tests/test_vector.py:11:4:6:     st.txyz.pop      ",
        "                                 ^^               ",
    ]
)
...
@want(
    errors=[
        ...
        "tests/test_vector.py:12:4:6:     st.txy.xyz = 0x99",
        "                                 ^^               ",
    ]
)
...
@want(
    errors=[
        "Reference to too many axes.                       ",
        "tests/test_vector.py:11:17:19:     st.txyz.xy = st.txy.z",
        "                                                ^^",
    ]
)
...
@want(
    errors=[
        ...
        "tests/test_vector.py:9:18:20:     x = p2g.Fixed[10]()",
        "                                                ^^",
    ]
)
def test_cerror_oob():
...
@want(
    errors=[
        ...
        "tests/test_vector.py:27:28:32:     assert not (p2g.address(ptr2.x) != p2g.address(st.txyz.x))",
        "                                                           ^^^^",
    ]
)
